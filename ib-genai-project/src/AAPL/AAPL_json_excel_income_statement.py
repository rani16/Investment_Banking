...
json_folder = r"C:\AZ_DEVOPS_PYTHON\Investment_Banking\ib-genai-project\data\json\AAPL\income_statement"

# Folder where Excel files will be created
excel_folder = r"C:\AZ_DEVOPS_PYTHON\Investment_Banking\ib-genai-project\data\excel\AAPL\income_statement"
