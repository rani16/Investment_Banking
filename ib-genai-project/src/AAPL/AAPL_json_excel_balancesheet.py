...
json_folder = r"C:\AZ_DEVOPS_PYTHON\Investment_Banking\ib-genai-project\data\json\AAPL\balance_sheet"

# Folder where Excel files will be created
excel_folder = r"C:\AZ_DEVOPS_PYTHON\Investment_Banking\ib-genai-project\data\excel\AAPL\balance_sheet"
